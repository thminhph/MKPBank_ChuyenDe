...
namespace DAL
{
    public class DAL_KhachHangCaNhan
    {
        ...
        public void Them(DTO_KhachHangCaNhan kh)
        {
            dContext = new Data_Context();
            try
            {
        ...
        {
            dContext = new Data_Context();
            var sua = dContext.Db.KhachHangCaNhans.Single(khachHang => khachHang.IdKhachHangCN == kh.Id);
            sua.TenKhachHang = kh.TenKhachHang;
            sua.DiaChi = kh.DiaChi;
            sua.SoDienThoai = kh.Sdt;
            ...
            var sua1 = dContext.Db.ChiTietKHCNs.Single(khachHang => khachHang.IdKhachHangCN == kh.Id);
        ...
        {
            dContext = new Data_Context();
            var xoa = dContext.Db.KhachHangCaNhans
            ...
            {
                dContext.Db.KhachHangCaNhans.DeleteOnSubmit(item);
            }
