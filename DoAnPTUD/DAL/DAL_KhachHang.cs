        ...
        public void ThemKHCaNhan(DTO_KhachHang kh)
        {
            ...
            try
            {
                KhachHang khachHang = new KhachHang
                {
                    ...
                    DiaChi = string.IsNullOrEmpty(kh.DiaChi) ? null : kh.DiaChi,
                    Email = string.IsNullOrEmpty(kh.Email) ? null : kh.Email,
                    LoaiGiayTo = string.IsNullOrEmpty(kh.LoaiGiayTo) ? null : kh.LoaiGiayTo,
                    IdNganh = kh.IdNganh,
                    NgayCap = kh.NgayCap,
                    ...
                    NoiCap = string.IsNullOrEmpty(kh.NoiCap) ? null : kh.NoiCap,
                    ...
                    TenKhachHang = string.IsNullOrEmpty(kh.TenKhachHang) ? null : kh.TenKhachHang,
                    NhanVienLV = string.IsNullOrEmpty(kh.NhanVienLV) ? null : kh.NhanVienLV,
                    SoGiayTo = string.IsNullOrEmpty(kh.SoGiayTo) ? null : kh.SoGiayTo,
            ...
            {
                throw new InvalidOperationException("Cần nhập những giá trị bắt buộc vui lòng kiểm tra lại");
            }
        }
