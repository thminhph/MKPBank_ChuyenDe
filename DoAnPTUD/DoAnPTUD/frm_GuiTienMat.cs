...
namespace DoAnPTUD
{
    public partial class frm_GuiTienMat : Form
    {
        ...
        void LoadChiTietGuiTien()
        {
            ...
            DTO_GuiTienMat gt = bllGT.LayChiTietGT(id);
            txtIDGuiTienMat.Text = gt.IdGuiTien;
            cbLoaiTK.SelectedIndex = 0;
            txtIdTk.Text = gt.IdTK.ToString();
            List<string> list = bllGT.LayThongTinKhachHang(gt.IdTK);
            lbCIF.Text = list[0];
            lbTenKH.Text = list[1];
            lbTenTK.Text = list[2];
        ...
        public DTO_GuiTienMat GuiTienMat()
        {
            DTO_GuiTienMat tm = new DTO_GuiTienMat(
                ...
                Convert.ToInt32(cbLoaiTK.SelectedValue),
                txtNoiDung.Text,
        ...
        private void frm_GuiTienMat_Load(object sender, EventArgs e)
        {
